          ...
          <>
            {shareLink.id && shareLink.key !== undefined ? (
              <>
                ...
                {copiedLink && (
                  <p>
                    <small className="text-green">Lien de partage copié avec succès!</small>
                  </p>
                )}
              ...
              <div id="error-message" className="row justify-content-center my-5 text-red">
                ...
                <p className="align-middle ml-2 mt-1">Impossible de générer le lien de partage.</p>
              </div>
            )}
          </>
        )}
...
const Loader: FunctionComponent = () => (
  <>
    ...
    <p className="my-4">Générer un lien de partage...</p>
  </>
);
